...
function MentionsText() {
    return (
        ...
        <div className='whoami mentions-container'>
            ...
            <p className="center-text">PLANCKAERT Gabriel<br />
